# Diagnostic: connect to the Classick daemon pipe and dump every event.
# Usage: pwsh scripts/probe-daemon.ps1
# Press Ctrl-C to exit.

$pipe = New-Object System.IO.Pipes.NamedPipeClientStream('.', 'classick',
    [System.IO.Pipes.PipeDirection]::InOut,
    [System.IO.Pipes.PipeOptions]::Asynchronous)
$pipe.Connect(3000)
Write-Host "Connected to \\.\pipe\classick" -ForegroundColor Green
